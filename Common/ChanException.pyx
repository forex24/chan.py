...
cdef class CChanException(Exception):
    ...
    def __cinit__(self, str message, ErrCode code=ErrCode.COMMON_ERROR):
        self.errcode = code
        self.msg = message
    ...
    def __str__(self):
        return f"{self.msg} (ErrCode: {self.errcode})"

    def __repr__(self):
        return f"CChanException({self.msg!r}, {self.errcode!r})"
